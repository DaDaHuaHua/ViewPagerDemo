 ...
 */
public class MyLazyFragment01 extends LazyFragment {
    private int mNumber;
    ...
    protected void getData() {
        mTextView.setText("这是第" + mNumber + "个------MyLazyFragment01");
        Log.i("TAG" ,"getData--第 "+ mNumber + "个------MyLazyFragment01");
    }
    ...
    protected void umengStart() {
        Log.i("TAG","Lazy01--UmengStart");
    }

    @Override
    protected void umengEnd() {
        Log.i("TAG","Lazy01--UmengEnd");
    }
}
